export const enUSSearchMessages = {
  search_page: {
    ...
    extract_depth_description: 'Use basic for faster extraction and advanced for richer page capture.',
    ...
    extract_chunks_description: 'How many relevant content chunks to keep from each extracted page.',
    ...
    crawl_external_description:
      'Permit the crawl to follow links that leave the starting domain.',
    toast: {
