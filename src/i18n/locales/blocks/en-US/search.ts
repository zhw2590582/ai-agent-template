export const enUSSearchMessages = {
  search_page: {
    ...
    topic_description: 'Used when the model calls web search without a specific topic.',
    topic_general: 'General',
    topic_news: 'News',
    topic_finance: 'Finance',
    max_results_label: 'Max results',
    max_results_description: 'How many Tavily results to return for each search.',
    toast: {
