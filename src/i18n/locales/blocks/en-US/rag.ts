export const enUSRagMessages = {
  rag_page: {
    ...
    api_key_description:
      'Used to generate vector embeddings for retrieval. This key is stored in your profile settings.',
    api_key_placeholder: 'Enter your vector API key',
    api_key_hint:
      'RAG retrieval needs a vector API key. A server-level fallback can still be configured for development.',
