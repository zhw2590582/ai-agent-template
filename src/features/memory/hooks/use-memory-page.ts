...
export function useMemoryPage({
  ...
  return {
    handleExport,
    ...settingsDraft,
    currentMemoryPage: memoryItemsSource.currentPage,
    ...
    memoryTotalItems: memoryItemsSource.totalItems,
    memoryTotalPages: memoryItemsSource.totalPages,
    ...
    setMemoryPage: memoryItemsSource.setPage,
